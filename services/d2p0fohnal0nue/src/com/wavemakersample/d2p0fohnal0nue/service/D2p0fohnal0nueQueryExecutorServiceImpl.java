...
@Service
public class D2p0fohnal0nueQueryExecutorServiceImpl implements D2p0fohnal0nueQueryExecutorService {
	private static final Logger LOGGER = LoggerFactory.getLogger(D2p0fohnal0nueQueryExecutorServiceImpl.class);

	@Autowired
	@Qualifier("d2p0fohnal0nueWMQueryExecutor")
