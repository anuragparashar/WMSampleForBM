...
import com.wavemakersample.d2p0fohnal0nue.service.D2p0fohnal0nueQueryExecutorService;
...
@RestController(value = "D2p0fohnal0nue.QueryExecutionController")
@Api(value = "QueryExecutionController", description = "Controller class for query execution")
@RequestMapping("/d2p0fohnal0nue/queryExecutor")
public class QueryExecutionController {

    private static final Logger LOGGER = LoggerFactory.getLogger(QueryExecutionController.class);

    @Autowired
    private D2p0fohnal0nueQueryExecutorService queryService;
